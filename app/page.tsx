...
export default function LandingPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      items: [
        { q: 'How much do I earn per placement?', a: "70% of the placement fee. As we transition to a professional model, fees vary: some roles have fixed bonuses ($10K–$25K) from existing relationships, while new partnerships are moving toward percentage-based fees (15–20% of base salary). Each role clearly shows its fee structure. On a $350K senior hire at a 20% fee, you earn $49,000. On a fixed $15K bonus role, you earn $10,500. Your 70% share is constant — no tiering, caps, or clawbacks." },
        { q: 'When do I get paid?', a: "Within 14 business days after the candidate completes the guarantee period. Guarantee periods typically run 3 months from the candidate's start date. Once they pass that mark, we release your payout immediately — no back-and-forth, no chasing." },
        ...
        { q: "What if the hire's employment ends during the guarantee period?", a: "If the hire's employment ends for any reason during the guarantee period, no payout is made — but no clawback either. Refery refunds the client directly and no money has changed hands, so nothing to return on your end. Your 24-month candidate protection on that person remains fully active for any other role they match with on the platform." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Can I work with other platforms or run my own agency in parallel?', a: "Absolutely. No exclusivity. No non-compete. Work with other marketplaces, run your own book, keep direct clients — whatever the mix of your business. The only restriction is you can't dual-submit the same candidate to the same company through Refery and another channel." },
        ...
        { q: 'Are there any clawbacks I should know about?', a: "Zero clawbacks on paid placements. The only \"no-payout\" scenario is when a hire's employment ends before completing the guarantee period — and in that case, no money has changed hands in the first place, so there's nothing to claw back. Once your payout lands, it's yours." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Why do some roles show different fee structures?', a: "We're professionalizing from a community model to standardized terms. Existing partnerships may have fixed bonuses ($10K–$25K) from earlier agreements. New partnerships are moving toward percentage-based fees (15–20%). Every role clearly displays its confirmed fee — you always know exactly what you'll earn before submitting candidates." },
      ]
    },
  ]
    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          }}>Partner Recruiter Platform</span>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '80px 40px 64px' }} className="hero">
        ...
        <h1 style={{
          ...
          {"You've built the teams behind the next big "}
          <span style={{ display: 'inline-block', height: '1.15em', overflow: 'hidden', verticalAlign: 'bottom', position: 'relative', paddingTop: '0.05em' }}>
            <span className="flip-track">
              <span style={{ height: '1.15em', display: 'flex', alignItems: 'baseline', fontStyle: 'italic', color: 'var(--green)', paddingBottom: '0.05em' }}>unicorns.</span>
              <span style={{ height: '1.15em', display: 'flex', alignItems: 'baseline', fontStyle: 'italic', color: 'var(--green)', paddingBottom: '0.05em' }}>IPOs.</span>
              <span style={{ height: '1.15em', display: 'flex', alignItems: 'baseline', fontStyle: 'italic', color: 'var(--green)', paddingBottom: '0.05em' }}>breakthroughs.</span>
            </span>
          </span>
        </h1>

        <p style={{ fontSize: 19, fontWeight: 400, lineHeight: 1.75, color: 'var(--ink-2)', maxWidth: 620, marginBottom: 40 }}>
          {"The founding engineers. The first GTM hires. The leaders who turned pitch decks into products. You found them. Now get paid like the dealmaker you are — zero BD, zero overhead. Just the part you're best at."}
        </p>
        ...
        <p style={{ fontSize: 14, color: 'var(--ink-3)', marginTop: 20 }}>
          200+ VC-backed startups hiring through our network.{' '}
          <a href="#about" style={{ color: 'var(--green)', textDecoration: 'none', fontWeight: 500 }}>{"Our story →"}</a>
        </p>
      ...
      <div id="earnings" className="sec reveal" style={{ padding: '80px 40px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 18, color: 'var(--ink-2)', lineHeight: 1.75, maxWidth: 580, marginBottom: 48 }}>
            {"Placement fees average 15–20% of first-year base, scaling with startup stage and role seniority. You keep 70% of every placement fee — compare that to the 20–30% you'd take home at an agency. Here's what that compounds to."}
          </p>

          {/* Earnings Banner */}
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 'clamp(48px, 6vw, 64px)', fontWeight: 400, lineHeight: 1.05, color: 'var(--ink)', marginBottom: 16 }}>
              <em style={{ fontStyle: 'italic', color: 'var(--green)' }}>$49,000</em> per placement.
            </div>
            <div style={{ fontSize: 18, color: 'var(--ink-2)', marginBottom: 20 }}>
              Example: 20% fee on a $350K senior hire · Placement fees avg. 15–20% · Your 70% share
            </div>
          </div>

          {/* Earnings Scale */}
          <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink-3)', margin: '56px 0 18px' }}>
            Earnings at scale · upper-range example · $49K per placement
          </div>
          <div className="earn-scale" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 1, background: 'var(--border)', borderRadius: 6, overflow: 'hidden' }}>
            <div style={{ background: 'var(--bg)', padding: '20px 16px', textAlign: 'center' }}>
              <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 28, fontWeight: 400, color: 'var(--ink)', lineHeight: 1 }}>$588K</div>
            ...
            <div style={{ background: 'var(--bg)', padding: '20px 16px', textAlign: 'center' }}>
              <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 28, fontWeight: 400, color: 'var(--ink)', lineHeight: 1 }}>$1.18M</div>
              <div style={{ fontSize: 13, color: 'var(--ink-3)', marginTop: 6 }}>per year</div>
            ...
            <div style={{ background: 'var(--ink)', padding: '20px 16px', textAlign: 'center' }}>
              <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 28, fontWeight: 400, color: '#5FBF84', lineHeight: 1 }}>$1.76M</div>
            ...
            <div style={{ background: 'var(--bg)', padding: '20px 16px', textAlign: 'center' }}>
              <div style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontSize: 28, fontWeight: 400, color: 'var(--ink)', lineHeight: 1 }}>$2.35M</div>
              <div style={{ fontSize: 13, color: 'var(--ink-3)', marginTop: 6 }}>per year</div>
          ...
          <div style={{ 
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-2)', lineHeight: 1.7 }}>
              <strong>What this means for fees:</strong> Some roles have fixed referral bonuses ($10K–$25K) from existing relationships. New partnerships are moving toward percentage-based fees (15–20%). Each role in the platform clearly shows the confirmed fee structure — either as a fixed amount or percentage. Roles we{"'"}re actively targeting or in early discussions with are marked as {"\"In Pipeline\""} so you can start identifying candidates proactively; when the partnership confirms, we match within 48 hours.
            </p>
          </div>
        </div>
      </div>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{ position: 'relative', paddingLeft: 52, maxWidth: 640, marginTop: 8 }}>
            ...
            {[
              ...
              { num: '05', time: 'On placement', title: 'Payout within 14 days', desc: "Candidate is hired and completes the guarantee period → payout processed within 14 business days. You earn regardless of which role they were ultimately placed in." },
            ].map((step, i) => (
