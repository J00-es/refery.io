              ...
              <div className="sv" data-s="2">
                <div className="slack" id="deskcard">
                  ...
                  <div className="msg"><div className="bot">R</div><div>
                    ...
                    <div className="live"><b style={{color:'#fff'}}>Live searches</b><div className="g"><b>Ridgeline &middot; Founding Engineer</b> (New York, Series A, fintech &middot; $200&ndash;300k) &middot; strong</div><div className="y"><b>Cobalt Bio &middot; Applied AI Engineer</b> &middot; possible &middot; thinner on ML serving</div></div>
