  ...
  const faqData = [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'When do I get paid?', a: "Two things have to be true: the candidate has passed 90 days of continuous employment, and Refery has collected the placement fee from the client. Once both are true, your payout goes out within 14 business days. On our standard client terms the client pays 30 days after the start date, so the money is already with us well before day 90 and day 90 is the only thing you are waiting on. A few clients are on longer terms, and there your payout follows their payment instead; we show you that timing on the role before you work it. The 90-day clock runs from the candidate's start date, and standard time off or approved leave (medical, parental, military) under the employer's own policies does not interrupt it." },
        ...
        { q: "What if the hire's employment ends during the guarantee period?", a: "If the hire's employment ends for any reason within the 90 days, whether that is resignation, performance, restructuring or layoff, no payout is made, but there is no clawback either. Refery holds the client's fee through the guarantee period and runs the replacement search directly, so nothing has been paid out to you and there is nothing to return. You are never involved in the replacement or in any dispute with the client. Your 24-month candidate protection on that person remains fully active for any other role they match with on the platform." },
