...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:560px;">
  ...
  <tr><td style="padding:0 0 14px 0; font-family:${SANS}; font-weight:600; font-size:24px; line-height:1.25; color:${M.green};">A search suggested for you, ${escapeHtml(first)}.</td></tr>
  ...
  <tr><td style="padding:0 0 28px 0; font-family:${SANS}; font-size:16px; line-height:1.65; color:${M.body};">Read the brief and the hiring manager&rsquo;s own words, then say in one tap whether you will work on it. It is a suggestion, not an assignment: nothing is expected until you say yes. If it is not your focus, one line on why tells us where to look next.</td></tr>
  ...
  try {
    ...
    const { error } = await resend.emails.send({
      ...
      to: input.to,
      replyTo: REPLY_TO,
      subject: `[Refery] ${input.fullName.trim()} | ${title} at ${company}, worth a look?`,
      html,
    })
