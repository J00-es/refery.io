/**
 * The partner desk's visual language. Values mirror app/globals.css (cream ground,
 * warm hairlines, forest accent, DM Sans). Keep the two in step.
 *
 ...
 */
export const CARD = 'rounded-[16px] bg-white border border-[#E4E3DC]'

/** The same object once it is interactive. Lift on hover, never on rest. */
export const CARD_LINK =
  'rounded-[16px] bg-white border border-[#E4E3DC] transition-[border-color,box-shadow] hover:border-[#D2D1C7] hover:shadow-[0_2px_12px_rgba(22,22,19,0.04)]'

/** A quiet region on the canvas — grouped by space, not boxed. */
export const WELL = 'rounded-[16px] bg-white/60'

export const FOCUS =
  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1F3A2F]/35 focus-visible:ring-offset-2 focus-visible:ring-offset-[#F2F1EB]'
 ...
 */
export const LABEL = 'text-[13px] font-normal text-[#9C9C95]'
/** A label that introduces a block above its content. Still sentence case. */
export const LEDE = 'text-[13.5px] leading-relaxed text-[#6E6E68]'
export const BODY = 'text-[14.5px] leading-relaxed text-[#2A2A26]'
export const META = 'text-[12.5px] text-[#9C9C95]'
 ...
 */
export const CHIP =
  'inline-flex max-w-full min-w-0 items-center gap-1.5 rounded-full bg-[#EAE9E1] px-2.5 py-1 text-[12px] font-medium leading-none text-[#6E6E68]'

/** The one chip allowed to be forest: what this is worth to the reader. */
export const CHIP_VALUE =
  'inline-flex items-center gap-1.5 rounded-full bg-[#E7EDE9] px-2.5 py-1 text-[12px] font-semibold leading-none text-[#1F3A2F]'

/** Needs attention. Amber, and only ever for something the reader must act on. */
export const CHIP_WARN =
  'inline-flex items-center gap-1.5 rounded-full bg-[#F5EEDD] px-2.5 py-1 text-[12px] font-semibold leading-none text-[#8A6A1F]'
...
// ── forms ───────────────────────────────────────────────────────────────────
export const FIELD_LABEL = 'block text-[13px] font-medium text-[#2A2A26]'
export const FIELD = `mt-1.5 w-full rounded-[12px] border border-[#D2D1C7] bg-white px-3 py-2.5 text-[14.5px] text-[#161613] placeholder:text-[#9C9C95] ${FOCUS}`
